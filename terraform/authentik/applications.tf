...
#   auth_groups        = [authentik_group.media.id]
#   authorization_flow = resource.authentik_flow.provider-authorization-implicit-consent.uuid
#   client_id          = module.secret_audiobookshelf.fields["audiobookshelf_oidc_client_id"]
#   client_secret      = module.secret_audiobookshelf.fields["audiobookshelf_oidc_client_secret"]
